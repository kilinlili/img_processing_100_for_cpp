...
cv::Mat affine(cv::Mat &src, double a, double b, double c, double d, double tx, double ty, double theta)
{
    //affine_kernel
    //double kernel[3][3] = {
    //    {a, b, tx},
...
int main(void)
{
    ...
    cv::Mat dst = affine(img, 1, 0, 0, 1, 0, 0, -30);
    ...
    cv::imwrite("./img/30q_ans2.jpg", dst);
